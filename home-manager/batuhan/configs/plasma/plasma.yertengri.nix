{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-2efcb4d1-ee29-4db1-b73d-6be111ec118a" = [ ];
      "ActivityManager"."switch-to-activity-de26d85f-cd97-4999-aa72-3c0237c7811f" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,1,28,20,54,2.863";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."2efcb4d1-ee29-4db1-b73d-6be111ec118a" = "Default";
      "kactivitymanagerdrc"."activities"."de26d85f-cd97-4999-aa72-3c0237c7811f" = "Coding";
      "kactivitymanagerdrc"."activities-descriptions"."2efcb4d1-ee29-4db1-b73d-6be111ec118a" = "Default activity to start in.";
      "kactivitymanagerdrc"."activities-descriptions"."de26d85f-cd97-4999-aa72-3c0237c7811f" = "Mostly coding stuff";
      "kactivitymanagerdrc"."activities-icons"."2efcb4d1-ee29-4db1-b73d-6be111ec118a" = "nix-snowflake";
      "kactivitymanagerdrc"."activities-icons"."de26d85f-cd97-4999-aa72-3c0237c7811f" = "codeblocks";
      "kactivitymanagerdrc"."main"."currentActivity" = "2efcb4d1-ee29-4db1-b73d-6be111ec118a";
      ...
      "katerc"."filetree"."editShade" = "102,94,79";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{3bacb74b-6b87-4ca3-8b81-6d58d19c8827}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{3a4d56e5-db08-4c31-800a-0eee152a46f1}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{59a60459-71d5-4fea-b7b4-0b2b5d4b04d8}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{0b4a5fbe-2d16-408e-91b3-50318d95dcf6}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{6a54ffa3-af50-446c-ae31-8cea182782d3}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{3f144d94-13bf-43f6-938b-671032021b4e}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{297220b5-f765-4594-8662-2aa69563df0c}";
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."2efcb4d1-ee29-4db1-b73d-6be111ec118a" = "b76942df-21b0-4a19-ac67-db42b21fd393";
      "kwinrc"."Activities/LastVirtualDesktop"."de26d85f-cd97-4999-aa72-3c0237c7811f" = "aed143f1-e1aa-4ea3-a039-921ac8db4cca";
      "kwinrc"."Desktops"."Id_1" = "b76942df-21b0-4a19-ac67-db42b21fd393";
      "kwinrc"."Desktops"."Id_2" = "a76836d0-4cb7-44e5-ac55-808137ce3499";
      "kwinrc"."Desktops"."Id_3" = "02dd1635-be3b-407b-ad70-22dcdad1c53c";
      "kwinrc"."Desktops"."Id_4" = "aed143f1-e1aa-4ea3-a039-921ac8db4cca";
      "kwinrc"."Desktops"."Id_5" = "8a0b2058-49ea-410b-ad70-9efc269a8a3e";
      "kwinrc"."Desktops"."Id_6" = "10e9f2f8-788e-494f-a48f-faf000b4bced";
      ...
      "kwinrc"."Effect-translucency"."Dialogs" = 81;
      "kwinrc"."Effect-translucency"."Menus" = 81;
      ...
      "kwinrc"."Tiling/c4c6c209-0dc9-552e-afbe-8000b0b57d37"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/dce9f0d5-48db-525c-a758-1f704ac14c93"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/f4c6aca7-c252-5cd5-858d-9893e5aba149"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/batuhan/Projects/home-manager/tests/modules/programs/kitty/default.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,993,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 953;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 953;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 993;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 572;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,953,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 993;
