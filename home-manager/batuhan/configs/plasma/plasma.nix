{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."Effect-translucency"."ComboboxPopups" = 89;
      "kwinrc"."Effect-translucency"."Dialogs" = 80;
      "kwinrc"."Effect-translucency"."Menus" = 90;
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/batuhan/Media/Pictures/Photos/AddToDigikam/Drone/MISC/IDX/idx00";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 365;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 365;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 195;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,365,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 2;
