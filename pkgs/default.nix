...
# You can build them using 'nix build .#example'
{
  ...
  user-audio-reencodeLossless = pkgs.callPackage ./userscripts/audio-reencodeLossless.nix 
  {
    inherit
  ...
  user-audio-reencodeLossy = pkgs.callPackage ./userscripts/audio-reencodeLossy.nix
  {
    inherit
